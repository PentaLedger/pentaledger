...
export const ROLE_PERMISSIONS: Record<UserRole, Permission[]> = {
  admin: [
    ...
    { resource: 'debt-calculator', actions: ['read', 'write', 'delete'] },
  ...
  manager: [
    ...
    { resource: 'debt-calculator', actions: ['read', 'write'] },
  ...
  accountant: [
    ...
    { resource: 'debt-calculator', actions: ['read'] },
...
export const NAVIGATION_ITEMS = [
  ...
  { path: '/debt-calculator', label: 'Debt Calculator', roles: ['admin', 'manager', 'accountant', 'user'] },

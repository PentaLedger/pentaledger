    ...
    namespace accounting
    {
        ...
        static std::unordered_map<int, std::unordered_map<RETIREMENT_ACCOUNT_TYPE, ContributionLimits>> contribution_limits_map = {
            ...
            {2024, {
                ...
                {IRA, {2024, IRA, 6500, 1000}},
                {ROTH_IRA, {2024, ROTH_IRA, 6500, 1000}},
                {SIMPLE_IRA, {2024, SIMPLE_IRA, 15500, 3000}},
                {SEP_IRA, {2024, SEP_IRA, 66000, 7500}},
                {R401K, {2024, R401K, 22500, 7500}},
                {OTHER, {2024, OTHER, 0.0, 0.0}} // Placeholder for other accounts
            }},
            {2023, {
                {OVERALL_IRA_LIMIT, {2023, OVERALL_IRA_LIMIT, 23500, 31000}},
                {IRA, {2023, IRA, 7000, 8000}},
                {ROTH_IRA, {2023, ROTH_IRA, 6500, 1000}},
                {SIMPLE_IRA, {2023, SIMPLE_IRA, 15500, 3000}},
                {SEP_IRA, {2023, SEP_IRA, 66000, 7500}},
                {R401K, {2023, R401K, 23500, 7500}},
